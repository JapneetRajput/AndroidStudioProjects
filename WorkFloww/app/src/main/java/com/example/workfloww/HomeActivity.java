...
public class HomeActivity extends AppCompatActivity {
    ...
    String getId;
    private static String URL_READ = "http://192.168.5.103/android_register_login/read_detail.php";
    private static String URL_EDIT = "http://192.168.5.103/android_register_login/edit_detail.php";
    private static String URL_UPLOAD = "http://192.168.5.103/android_register_login/upload.php";
    private Menu action;
